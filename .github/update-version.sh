...
curl -Ls "https://raw.githubusercontent.com/helm/helm/main/scripts/get-helm-3" | USE_SUDO=false HELM_INSTALL_DIR=$HOME/bin/ bash
...
for chart in $(PATH=$HOME/bin:$PATH ./ct --config .github/ct.yaml list-changed)
do
